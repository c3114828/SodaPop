...
{
    public class INFT3050PaymentSystem
    {
        /// <summary>
        ...
        public class INFT3050PaymentSystem : IPaymentSystem
        {
            ...
            new DummyPaymentAccount("betty boo", "5105105105105100", 2000, new DateTime(2018, 05, 1), 123, TransactionResult.Approved),
            new DummyPaymentAccount("carol carver", "2223000048400011", 300, new DateTime(2017, 09, 1), 123, TransactionResult.Approved),
